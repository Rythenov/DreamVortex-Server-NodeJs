...
var selectPlayerByUserIdString = "select * from player where user_id == ?";
...
function selectPlayerByUserId(user_id, callback){
    playerdb.get(selectPlayerByUserIdString, user_id, (err, res) =>{
        callback(res, err);       
    });
}
